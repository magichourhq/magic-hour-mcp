...
Source: https://docs.magichour.ai/api-reference/openapi.json (fetched and saved as `mcp_magichour/openapi.json`). Regenerate this file with `python docs/build_reference.py` if the spec changes.
